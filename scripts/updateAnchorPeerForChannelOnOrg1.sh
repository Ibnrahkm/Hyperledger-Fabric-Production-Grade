...
jq '.channel_group.groups.Application.groups.Org1MSP.values += {"AnchorPeers":{"mod_policy": "Admins","value":{"anchor_peers": [{"host": "peer0.ibrahim.com","port": 9051}]},"version": "0"}}' config_copy.json > modified_config.json
