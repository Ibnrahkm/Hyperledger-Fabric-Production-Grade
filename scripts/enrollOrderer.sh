...
fabric-ca-client enroll -u https://$2:$3@localhost:7054 --caname $1 -M ../crypto/orderers/$4/msp --csr.hosts '$4,*.propvalchain.com,localhost' --tls.certfiles $FABRIC_CA_SERVER_PATH/tls-cert.pem

fabric-ca-client enroll -u https://$2:$3@localhost:7054 --caname $1 -M ../crypto/orderers/$4/tls --enrollment.profile tls --csr.hosts '$4,*.propvalchain.com,localhost' --tls.certfiles $FABRIC_CA_SERVER_PATH/tls-cert.pem

cp ../ca/crypto/orderers/$4/tls/tlscacerts/tls-localhost-7054-capropvalchain.pem* ../ca/crypto/orderers/$4/tls/ca.crt
