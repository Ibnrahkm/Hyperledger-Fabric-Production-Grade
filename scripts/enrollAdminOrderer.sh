...
cp ../ca/crypto/orderers/$4/users/$5/tls/tlscacerts/* ../ca/crypto/orderers/$4/users/$5/tls/ca.crt
cp ../ca/crypto/orderers/$4/users/$5/tls/signcerts/* ../ca/crypto/orderers/$4/users/$5/tls/server.crt
cp ../ca/crypto/orderers/$4/users/$5/tls/keystore/* ../ca/crypto/orderers/$4/users/$5/tls/server.key


cd ../ca/crypto/orderers/$4/users/$5/msp
