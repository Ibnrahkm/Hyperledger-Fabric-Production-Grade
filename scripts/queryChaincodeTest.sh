...
peer chaincode query -o localhost:7050 --tls --cafile $ORDERER_CA  -C $CH_NAME -n $CHAINCODE_NAME --peerAddresses localhost:9051 --tlsRootCertFiles $CORE_PEER_TLS_ROOTCERT_FILE -c '{"function":"queryAllCars","Args":[]}'
