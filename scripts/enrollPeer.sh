...
fabric-ca-client enroll -u https://$2:$3@localhost:7054 --caname $1 -M ../crypto/$4/peers/$5/msp --csr.hosts $5 --tls.certfiles $FABRIC_CA_SERVER_PATH/tls-cert.pem

fabric-ca-client enroll -u https://$2:$3@localhost:7054 --caname $1 -M ../crypto/$4/peers/$5/tls --enrollment.profile tls --csr.hosts $5 --csr.hosts localhost --tls.certfiles $FABRIC_CA_SERVER_PATH/tls-cert.pem
